...
PHP_VERSION="8.3"
MYSQL_VERSION="8.0"
STANDALONE_APP_MAJOR_VERSION=4
...
# License key
while true; do
    read -rp "$(printf "${BOLD}Mixpost Pro license key${NC}: ")" INPUT_LICENSE_KEY
...
# Create the Mixpost project
info "Downloading Mixpost Pro (this may take a few minutes)..."

composer create-project inovector/mixpost-pro-team-app:^${STANDALONE_APP_MAJOR_VERSION}.0 /tmp/mixpost-app --no-interaction --prefer-dist
...
success "Mixpost Pro application installed."
...
echo ""
success "============================================"
success "  Mixpost Pro installed successfully!"
success "============================================"
echo ""
